    ...
    <section id="features" className="py-24 bg-slate-950 relative">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 auto-rows-fr gap-4 min-h-[900px] md:min-h-[600px]">
          ...
          {/* Neural Context Card */}
          <div className="md:col-span-1 rounded-3xl p-8 glass-card bg-gradient-to-br from-indigo-500/10 to-transparent hover:border-indigo-500/30 transition-all group relative overflow-hidden flex flex-col justify-end min-h-[250px]">
          ...
          <div className="md:col-span-2 rounded-3xl p-8 glass-card bg-gradient-to-br from-purple-500/10 to-transparent hover:border-purple-500/30 transition-all group relative overflow-hidden flex flex-col justify-end min-h-[250px]">
          ...
          {/* Instant Sync Card */}
          <div className="md:col-span-1 rounded-3xl p-8 glass-card bg-gradient-to-br from-emerald-500/10 to-transparent hover:border-emerald-500/30 transition-all group relative overflow-hidden flex flex-col justify-end min-h-[250px]">
          ...
          {/* Local-First Card */}
          <div className="md:col-span-2 rounded-3xl p-8 glass-card bg-gradient-to-br from-amber-500/10 to-transparent hover:border-amber-500/30 transition-all group relative overflow-hidden flex flex-col justify-end min-h-[250px]">
